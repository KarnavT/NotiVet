      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="flex items-center justify-center">
            <Logo size="2xl" variant="icon" className="bg-blue-100 rounded-full" clickable={false} />
          </div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            HCP Login
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in to access drug information and notifications
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-sm text-blue-700">
            <strong>Email:</strong> dr.smith@vetclinic.com<br />
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/hcp/register" className="font-medium text-blue-600 hover:text-blue-500">
                Register here
              </Link>
            </p>
